...
const Profile = () => {
    ...
    //         try {
    //             const response = await axios.get('http://localhost:8000/auth/getuserById'); // Replace with your API endpoint
                                                            ...
                                                            <div className="card-block">
                                                                ...
                                                                <div className="row">
                                                                    <div className="col-sm-6">
                                                                        ...
                                                                        <h6 className="text-muted f-w-400">First Name</h6>
                                                                    </div>
                                                                    <div className="col-sm-6">
                                                                        <p className="m-b-10 f-w-600">Last Name</p>
                                                                        <h6 className="text-muted f-w-400">Last Name</h6>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="row">
                                                                    <div className="col-sm-6">
                                                                        ...
                                                                        <h6 className="text-muted f-w-400">mohtady@gmail.com</h6>
                                                                    </div>
                                                                    <div className="col-sm-6">
                                                                        <p className="m-b-10 f-w-600">Phone</p>
                                                                        <h6 className="text-muted f-w-400">01111256859</h6>
                                                                    </div>
                                                                </div>
